...
gulp.task('html', function() {
    return gulp.src(['.tmp/*.html'])
        ...
        .pipe(gulp.dest('wordpress/wp-content/themes/total/assets/'));
});
...
gulp.task('fonts', function() {
    return gulp.src([
        ...
        .pipe(gulp.dest('wordpress/wp-content/themes/total/assets/fonts'));
});
...
gulp.task('clean', function() {
    return gulp.src(['wordpress/wp-content/themes/total/assets/*'], { read: false }) //much faster
        .pipe(rimraf({
            force: true
        }));
});